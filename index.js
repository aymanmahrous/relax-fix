...
<meta name="description" content="Relax Fix UAE provides AC maintenance, water tank cleaning, pest control and home maintenance services. Fast WhatsApp booking.">
<style>
...
.service-btn{background:#101d31;color:white;padding:25px;border-radius:18px;display:block;border:1px solid rgba(255,255,255,.1);transition:.2s;cursor:pointer}
...
Message: ${data.message}`
      ...
      res.end(page(`
        <div class="container" style="padding:60px 0;text-align:center;">
          ...
          <h2>Opening WhatsApp automatically...</h2>
          <p class="muted">Your request was saved. WhatsApp will open with your details.</p>

          <br>

          <a class="btn btn-wa" href="${whatsappUrl}" target="_blank">
            💬 Open WhatsApp Now
          </a>
...
<main>
  <section class="hero">
    <div class="container hero-grid">
      <div>
        ...
        <a class="btn btn-main" href="javascript:void(0)" onclick="scrollToBooking()">Book Service</a>
      ...
      <div class="card">
        <h2>Quick Booking</h2>
        <p class="muted">Send your request and WhatsApp will open automatically.</p>
  ...
  <section>
    <div class="container">
      <h2>Our Services</h2>
      <p class="muted">Click a service. It will fill the booking form automatically.</p>
